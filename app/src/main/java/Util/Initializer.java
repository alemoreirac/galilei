...
public class Initializer
{
    public static void InicializarPessoas()
    {
        ...
        dadosTerritoriais.add(new DadosTerritoriais("9º Distrito Policial", "Mucuripe", AreaIntegradaSeguranca.AIS_1));
        ...
        dadosTerritoriais.add(new DadosTerritoriais("34º Distrito Policial", "Moura Brasil", AreaIntegradaSeguranca.AIS_4));
        ...
        dadosTerritoriais.add(new DadosTerritoriais("25º Distrito Policial", "Serrinha", AreaIntegradaSeguranca.AIS_5));
        dadosTerritoriais.add(new DadosTerritoriais("25º Distrito Policial", "Bairro de Fátima", AreaIntegradaSeguranca.AIS_5));
        dadosTerritoriais.add(new DadosTerritoriais("25º Distrito Policial", "Aeroporto", AreaIntegradaSeguranca.AIS_5));
        ...
        dadosTerritoriais.add(new DadosTerritoriais("10º Distrito Policial", "Antônio Bezerra", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("10º Distrito Policial", "Quintino Cunha", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("10º Distrito Policial", "Olavo Oliveira", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("10º Distrito Policial", "Padre Andrade", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("10º Distrito Policial", "Bela Vista", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("10º Distrito Policial", "Presidente Kennedy", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("10º Distrito Policial", "Parquelândia", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("10º Distrito Policial", "Amadeu Furtado", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("10º Distrito Policial", "Parque Araxá", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("10º Distrito Policial", "Rodolfo Teófilo", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("27º Distrito Policial", "Bom Sucesso", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("27º Distrito Policial", "João XXIII", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("27º Distrito Policial", "Jóquei Clube", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("27º Distrito Policial", "Henrique Jorge", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("27º Distrito Policial", "Autran Nunes", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("27º Distrito Policial", "Pici", AreaIntegradaSeguranca.AIS_6));
        dadosTerritoriais.add(new DadosTerritoriais("27º Distrito Policial", "Dom Lustosa", AreaIntegradaSeguranca.AIS_6));
        ...
        dadosTerritoriais.add(new DadosTerritoriais("13º Distrito Policial", "Jardim das Oliveiras", AreaIntegradaSeguranca.AIS_7));
        ...
        dadosTerritoriais.add(new DadosTerritoriais("19º Distrito Policial", "Canindezinho", AreaIntegradaSeguranca.AIS_9));
        ...
        dadosTerritoriais.add(new DadosTerritoriais("15º Distrito Policial", "Cocó", AreaIntegradaSeguranca.AIS_10));
...
//        bairros.add(new Bairro("Vila Velha"));
        ...
        //delegas.add(new Delegacia("Delegacia Metropolitana de Maracana"));
