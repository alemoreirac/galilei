...
public class ColisaoTransito extends SugarRecord<ColisaoTransito>
{
    ...
    @Expose
    Conclusao conclusaoVeiculo1;
    @Expose
    Conclusao conclusaoVeiculo2;
    @Expose
    ...
    public Conclusao getConclusaoVeiculo1()
    {
        return conclusaoVeiculo1;
    }

    public void setConclusaoVeiculo1(Conclusao conclusaoVeiculo1)
    {
    ...
    public Conclusao getConclusaoVeiculo2()
    {
        return conclusaoVeiculo2;
    }

    public void setConclusaoVeiculo2(Conclusao conclusaoVeiculo2)
    {
